...
It uses light emiting diodes to iluminate a part of skin, e.g. on the wrist, upper arm
or finger tip and measures the light absorbtion of the skin with a photo diode. The frequency
between peaks of the absorbtion translates to the heart rate.
...
acceleretion values are analysed using a setup designed by Maximilian Kurscheidt for
the surveilance of hospital patients\cite{kurscheidt2016open}.
